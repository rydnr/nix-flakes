...
in
{
  ...
  "unknown".bstr."1.0.1" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      [ "alloc" ]
      [ "default" ]
      (lib.optional (rootFeatures' ? "bstr/serde") "serde")
      [ "std" ]
      [ "unicode" ]
    ];
    dependencies = {
    ...
    devDependencies = {
      ...
      ucd_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ucd-parse."0.1.10" { inherit profileName; };
  ...
  "unknown".bstr-bench."0.0.1" = overridableMkRustCrate (profileName: rec {
    name = "bstr-bench";
    version = "0.0.1";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ucd-parse."0.1.10" = overridableMkRustCrate (profileName: rec {
    name = "ucd-parse";
    version = "0.1.10";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fc2d0556a998f4c55500ce1730901ba32bafbe820068cbdc091421525d61253b"; };
    dependencies = {
      once_cell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.17.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.7.3" { inherit profileName; };
    };
