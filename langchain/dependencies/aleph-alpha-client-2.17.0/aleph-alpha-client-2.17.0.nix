{ buildPythonPackage, fetchPypi, lib, poetry, mkPoetryApplication, setuptools }:

buildPythonPackage rec {
  pname = "aleph-alpha-client";
  version = "2.17.0";
  format = "pyproject";

  src = fetchPypi {
    inherit pname version;
    sha256 = "9106a36a5e08dba6aea2b0b2a0de6ff0c3bb77926edc98226debae121b0925e2";
  };
