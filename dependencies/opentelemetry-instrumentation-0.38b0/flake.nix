{
  description = "A Nix flake for opentelemetry-instrumentation 0.38b0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          opentelemetry-instrumentation-0.38b0 = (import ./opentelemetry-instrumentation-0.38b0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          opentelemetry-instrumentation = packages.opentelemetry-instrumentation-0.38b0;
          default = packages.opentelemetry-instrumentation;
          meta = with lib; {
            description = ''
