{
  description = "A Nix flake for tensorflow-io-gcs-filesystem 0.32.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          tensorflow-io-gcs-filesystem-0.32.0 = (import ./tensorflow-io-gcs-filesystem-0.32.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          tensorflow-io-gcs-filesystem = packages.tensorflow-io-gcs-filesystem-0.32.0;
          default = packages.tensorflow-io-gcs-filesystem;
          meta = with lib; {
            description = ''
<div align="center">
