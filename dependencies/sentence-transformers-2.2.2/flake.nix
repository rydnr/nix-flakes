{
  description = "A Nix flake for sentence-transformers 2.2.2 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          sentence-transformers-2.2.2 = (import ./sentence-transformers-2.2.2.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          sentence-transformers = packages.sentence-transformers-2.2.2;
          default = packages.sentence-transformers;
          meta = with lib; {
            description = ''
<!--- BADGES: START --->
