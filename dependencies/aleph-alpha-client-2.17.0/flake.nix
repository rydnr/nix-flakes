{
  description = "A Nix flake for aleph-alpha-client 2.17.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          aleph-alpha-client-2.17.0 = (import ./aleph-alpha-client-2.17.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          aleph-alpha-client = packages.aleph-alpha-client-2.17.0;
