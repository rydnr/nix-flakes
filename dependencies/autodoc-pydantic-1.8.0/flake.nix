{
  description = "A Nix flake for autodoc-pydantic 1.8.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          autodoc-pydantic-1.8.0 = (import ./autodoc-pydantic-1.8.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          autodoc-pydantic = packages.autodoc-pydantic-1.8.0;
          default = packages.autodoc-pydantic;
          meta = with lib; {
            description = ''
