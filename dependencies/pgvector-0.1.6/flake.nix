{
  description = "A Nix flake for pgvector 0.1.6 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          pgvector-0.1.6 = (import ./pgvector-0.1.6.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          pgvector = packages.pgvector-0.1.6;
          default = packages.pgvector;
          meta = with lib; {
            description = ''
# pgvector-python
