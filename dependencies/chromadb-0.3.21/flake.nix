{
  description = "A Nix flake for chromadb 0.3.21 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          chromadb-0.3.21 = (import ./chromadb-0.3.21.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          chromadb = packages.chromadb-0.3.21;
          default = packages.chromadb;
          meta = with lib; {
            description = ''
<p align="center">
