{
  description = "A Nix flake for weaviate-client 3.15.5 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          weaviate-client-3.15.5 = (import ./weaviate-client-3.15.5.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          weaviate-client = packages.weaviate-client-3.15.5;
          default = packages.weaviate-client;
          meta = with lib; {
            description = ''
