{
  description = "A Nix flake for psycopg2-binary 2.9.6 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          psycopg2-binary-2.9.6 = (import ./psycopg2-binary-2.9.6.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          psycopg2-binary = packages.psycopg2-binary-2.9.6;
          default = packages.psycopg2-binary;
          meta = with lib; {
            description = ''
