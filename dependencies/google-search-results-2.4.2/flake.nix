{
  description = "A Nix flake for google-search-results 2.4.2 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          google-search-results-2.4.2 = (import ./google-search-results-2.4.2.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          google-search-results = packages.google-search-results-2.4.2;
          default = packages.google-search-results;
          meta = with lib; {
            description = ''
