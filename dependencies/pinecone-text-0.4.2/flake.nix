{
  description = "A Nix flake for pinecone-text 0.4.2 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          pinecone-text-0.4.2 = (import ./pinecone-text-0.4.2.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          pinecone-text = packages.pinecone-text-0.4.2;
          default = packages.pinecone-text;
          meta = with lib; {
            description = ''
<h1 align="center">
