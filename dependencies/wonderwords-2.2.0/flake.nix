{
  description = "A Nix flake for wonderwords 2.2.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          wonderwords-2.2.0 = (import ./wonderwords-2.2.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          wonderwords = packages.wonderwords-2.2.0;
          default = packages.wonderwords;
          meta = with lib; {
            description = ''
# Wonderwords
