{
  description = "A Nix flake for sphinx-panels 0.6.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          sphinx-panels-0.6.0 = (import ./sphinx-panels-0.6.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          sphinx-panels = packages.sphinx-panels-0.6.0;
          default = packages.sphinx-panels;
          meta = with lib; {
            description = ''
# sphinx-panels
