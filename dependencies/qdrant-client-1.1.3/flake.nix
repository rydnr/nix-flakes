{
  description = "A Nix flake for qdrant-client 1.1.3 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          qdrant-client-1.1.3 = (import ./qdrant-client-1.1.3.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          qdrant-client = packages.qdrant-client-1.1.3;
          default = packages.qdrant-client;
          meta = with lib; {
            description = ''
