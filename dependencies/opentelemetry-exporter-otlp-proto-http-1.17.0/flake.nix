{
  description = "A Nix flake for opentelemetry-exporter-otlp-proto-http 1.17.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          opentelemetry-exporter-otlp-proto-http-1.17.0 = (import ./opentelemetry-exporter-otlp-proto-http-1.17.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          opentelemetry-exporter-otlp-proto-http = packages.opentelemetry-exporter-otlp-proto-http-1.17.0;
          default = packages.opentelemetry-exporter-otlp-proto-http;
          meta = with lib; {
            description = ''
