{
  description = "A Nix flake for pinecone-client 2.2.1 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          pinecone-client-2.2.1 = (import ./pinecone-client-2.2.1.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          pinecone-client = packages.pinecone-client-2.2.1;
          default = packages.pinecone-client;
          meta = with lib; {
            description = ''
# pinecone-client
