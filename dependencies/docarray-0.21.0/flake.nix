{
  description = "A Nix flake for docarray 0.21.0 Python package";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        packages = {
          docarray-0.21.0 = (import ./docarray-0.21.0.nix) {
            inherit (pythonPackages)
              buildPythonPackage fetchPypi
             inherit (pkgs) lib;
          };
          docarray = packages.docarray-0.21.0;
          default = packages.docarray;
          meta = with lib; {
            description = ''
<p align="center">
