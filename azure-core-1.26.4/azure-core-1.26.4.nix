# Generated on 2023-05-12 10:56:54.065176 by the package.nix.tmpl template in the setup.py+fetchfromgithub+monorepo recipe for [https://github.com/rydnr/python-nix-flake-generator]. Changes will be overwritten.
{ buildPythonPackage, fetchFromGitHub, lib, setuptools, typing-extensions, six, aiohttp, requests, opencensus, trio }:
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    rev = "azure-core_1.26.4";
    sha256 = "sha256-ACwWIdG3UVTwlz3MNLEgqD+Vc6tB5fRiE1zOUrmJj0A=";
  };
