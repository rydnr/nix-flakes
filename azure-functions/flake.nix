# azure-functions/flake.nix
#
# This file packages azure-functions as a Nix flake.
#
      ...
      in rec {
        ...
        devShells = rec {
          ...
          azure-functions-python39 = shared.devShell-for {
            ...
            package = packages.azure-functions-python39;
          ...
          azure-functions-python310 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python310
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.azure-functions-python310;
          ...
          azure-functions-python311 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python311
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.azure-functions-python311;
          ...
          azure-functions-python312 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python312
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.azure-functions-python312;
        ...
        packages = rec {
          ...
          azure-functions-python310 =
            azure-functions-for { python = pkgs.python310; };
          azure-functions-python311 =
